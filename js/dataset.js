var experienceList = [
    ...
    },
    {
        ...
        "bulletpoints": ["Google Assistant (Tappable Assistant)."]
    },
    {
        "image": {
        ...
        "bulletpoints": [
            "Developed and deployed multiple features to the Instabase platform for customer use."],
        "links": [
    ...
    },
    {
        ...
        "bulletpoints": ["Backend development on storage/databases team for Messenger Infrastructure.",
    ...
    },
    {
        ...
        "bulletpoints": ["Trained models and developed computer vision pipeline to detect annotations/marginalia, of interest to researchers, in digital copies of old books and manuscripts.",
    ...
    },
    {
        ...
        "bulletpoints": ["Analyzed Android Instant App memory footprints and visibility, among other factors, to determine causes of instant app crashes in low memory situations.",
            "Implemented instant app process management system in Java to gracefully manage life cycles of Android Instant Apps and ensure reliably smooth user experience."]
    },
    {
        "image": {
        ...
        "bulletpoints": ["Use of smart devices in allowing physicians to remotely monitor patient health and activity, primarily in the geriatric population.",
    ...
    },
    {
        ...
        "bulletpoints": ["Worked with local startup (~6 members) as lead Android developer building a service to reward users playing games on the PlayFull application with discounts at restaurants.",
...
var projectList = [
    ...
    },
    {
        ...
        "line3": "March 2019",
        "bulletpoints": [
            "Development (in PyTorch) and comparison of Autoencoders (AEs) and Variational Autoencoders (VAEs) as generative models on the MNIST and Eigenfaces datasets."
        ],
        "links": [
    ...
    },
    {
        ...
        "bulletpoints": [
            "Custom final project designed and developed during UCLA's CS 152B course.",
            ...
            "Credit also goes to my two partners: Jeff Au-Yeung and Naing Min"
        ],
        "links": [
    ...
    },
    {
        ...
        "bulletpoints": [
            "Trained machine learning algorithm on ambient WiFi RSSI values to achieve F-measures approaching and far above 0.9 in university and home environments.",
    ...
    },
    {
        ...
        "bulletpoints": [
            "Developed a door unlocking system triggered by a secret knock code set by the user.",
    ...
    },
    {
        ...
        "line3": "April 2016",
        "bulletpoints": [
            "Developed an app/service to connect people in need of favors with those in the general public who can help them.",
    ...
    },
    {
        ...
        "line3": "February 2016",
        "bulletpoints": [
            "Project completed and submitted for the 2016 Hacktech competition (Caltech Hackathon).",
    ...
    },
    {
        ...
        "bulletpoints": [
            "Learned Android development and basic game design principles using the libGDX game engine.",
